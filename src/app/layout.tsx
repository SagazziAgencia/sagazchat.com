...
export const metadata: Metadata = {
  title: 'Respondechat.ai - Sua Máquina de Vendas Automática',
  description: 'Automatize suas vendas no WhatsApp com a inteligência artificial e CRM nativo do Respondechat.ai.',
};
