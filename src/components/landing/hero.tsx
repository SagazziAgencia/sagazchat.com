  ...
  return (
    <section className="relative z-10 pt-20 pb-20 lg:pt-28 lg:pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="max-w-4xl text-center space-y-8 animate-fade-in-up mb-12">
          
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#92D639]/10 border border-[#92D639]/30 text-[#92D639] text-xs font-bold uppercase tracking-wide mx-auto hover:bg-[#92D639]/20 transition-colors cursor-default">
          ...
          <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-gray-500">
