      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-[#92D639]/10 border border-[#92D639]/30 text-[#92D639] text-xs font-bold uppercase tracking-wide mx-auto lg:mx-0 hover:bg-[#92D639]/20 transition-colors cursor-default">
              <TrendingUp className="w-3 h-3" />
              <span>Líder em Vendas no WhatsApp</span>
            </div>

            <h1 className="mt-8 text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] tracking-tight">
              Sua Máquina de <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-8">
              <Button size="lg" className="group relative w-full sm:w-auto px-8 py-4 h-auto bg-[#92D639] text-black font-bold text-lg hover:bg-[#82c232] transition-all shadow-[0_0_20px_rgba(146,214,57,0.4)] hover:shadow-[0_0_40px_rgba(146,214,57,0.6)] hover:-translate-y-1">
                <UserPlus size={20} />
                Assinar Agora
                <ArrowRight className="inline-block ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button size="lg" variant="outline" className="border-gray-600 text-gray-300 font-medium hover:border-[#92D639] hover:text-white transition-all bg-white/5 backdrop-blur-sm">
                Ver na Prática
              </Button>
            </div>
